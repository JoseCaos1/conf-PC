...
##Ejecutar este comando para ponerlo en el path de python, primero python para el
##ver la version ejecutandose y luego lo ponermos la version en el comando
